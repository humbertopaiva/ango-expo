...
export function VariationNewScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <AdminScreenHeader title="Nova Variação" backTo="/admin/products" />
      ...
      <ScrollView className="flex-1 p-4">
        <View className="bg-blue-50 p-4 rounded-lg mb-6">
          ...
          <Text className="text-blue-700">
            Variações permitem que você configure diferentes opções para seus
            produtos, como tamanhos, cores ou outras características. Após criar
            um tipo de variação, você poderá associá-lo aos seus produtos.
          </Text>
        </View>
      ...
      <View className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4">
        <FormActions
          primaryAction={{
            label:
              isSubmitting || isCreating ? "Salvando..." : "Salvar Variação",
